...
| Name | Detail | Exported From | Supported Ailia Version |
|:-----------|------------:|:------------:|:------------:|
|[gemma](/natural_language_processing/gemma) | [Gemma 3n](https://huggingface.co/google/gemma-3n-E2B-it) text chat (gguf) via [ailia LLM](https://github.com/ailia-ai/ailia-llm-cpp) | gguf | 1.5.0 and later | |
|[gemma-multimodal](/natural_language_processing/gemma-multimodal) | [Gemma 3n](https://huggingface.co/google/gemma-3n-E2B-it) multimodal (gguf + mmproj) via [ailia LLM](https://github.com/ailia-ai/ailia-llm-cpp) | gguf | 1.5.0 and later | |
...
| Name | Detail | Exported From | Supported Ailia Version |
|:-----------|------------:|:------------:|:------------:|
| [bytetrack](/object_tracking/bytetrack/) | [ByteTrack](https://github.com/ifzhang/ByteTrack) | Pytorch | 1.2.6 and later |
